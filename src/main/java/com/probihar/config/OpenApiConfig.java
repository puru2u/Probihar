...
//        }
    ...
    // No need for an OpenAPI bean unless you want to add further customizations
...
////        server.setUrl(apiEndPoint);
////
//        return new OpenAPI().servers(Collections.singletonList((io.swagger.v3.oas.models.servers.Server) server))
//                .addSecurityItem(new SecurityRequirement().addList(securitySchemeName))
//                .components(
//                        new Components()
//                                .addSecuritySchemes(securitySchemeName,
...
//                                                .bearerFormat("JWT")
//                                )
//                ).info(new Info("").title("Drive Metadata API").version("v1"));
//    }
